...
Rectangle {
    ...
    Item {
        ...
        Timer {
            ...
            onTriggered: {
                if (!root.expanded)
                    IslandManager.removeIsland("brightness");
            }
        }
        ...
        Connections {
            ...
            function onBrightnessAdjusted() {
                IslandManager.addIsland("brightness", 7, {});
                root.forceNotificationIsland = false;
                root.forceWorkspaceIsland = false;
                root.expanded = false;
    ...
    Item {
        ...
        RowLayout {
            ...
            StyledText {
                ...
                font.pixelSize: Theme.fontSizeLarge
                font.bold: true
                visible: root.displayedIslandType() === "brightness"
            }
            ...
            RoundedImage {
                ...
                visible: MediaService.isPlaying && root.displayedIslandType() !== "volume" && root.displayedIslandType() !== "localsend" && root.displayedIslandType() !== "brightness"
            ...
            DonutChart {
                ...
                icon: ""
                fgColor: root.displayedIslandType() === "brightness" ? Theme.yellow : Theme.blue
                lineWidth: 3
                visible: root.displayedIslandType() === "volume" || root.displayedIslandType() === "brightness" || root.displayedIslandType() === "localsend" || MediaService.isPlaying
                value: {
                    if (root.displayedIslandType() === "localsend")
                        return LocalSendService.progress;
                    if (root.displayedIslandType() === "volume")
                        return VolumeService.displayPercent;
                    if (root.displayedIslandType() === "brightness")
                        return BrightnessService.percent;
                    return MediaService.progress * 100;
                }
            }
        }
